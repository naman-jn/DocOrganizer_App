...
class TagsPage extends StatefulWidget {
  ...
  TagsPage(Key key, this.homeState,this.changeDrawer,this.showSnackBar) : super(key: key);
...
class TagsPageState extends State<TagsPage> {
  ...
  Widget getTagListView() {
    return RefreshIndicator(
      onRefresh: (){return Future.delayed(Duration(milliseconds: 1100),()=>updateListView());},
      color: Colors.blue,
                ...
                child: FocusedMenuHolder(
                  ...
                  menuItems: [
                    ...
                    FocusedMenuItem(
                      ...
                      trailingIcon: Icon(Icons.delete_sweep,color: Colors.white,),
                        backgroundColor: Colors.red
                    ),
                  ],
                  child: ExpansionTile(
                    childrenPadding: EdgeInsets.only(bottom: 10),
                    title: Text(tagList[i].name,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18,letterSpacing: 1.5,color: Colors.blueGrey),),
                    children: tagList[i]
                        .toList()
                        .map((fileId) => fileId == ''
                            ? Text(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(icon: Icon(Icons.delete_sweep,color: Colors.black.withOpacity(0.7),), onPressed: (){
                setState(() {
    ...
    Dialog dialog = Dialog(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Add file to tag',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 21,letterSpacing: 1.2,color: Colors.white)),
            SizedBox(height: 10,),
  ...
  ListView getFileListView(Tag tag) {
    return ListView.builder(
        ...
        itemBuilder: (context, i) => Card(
          shape: RoundedRectangleBorder(side: BorderSide(color: Colors.blue),borderRadius: BorderRadius.circular(11)),

          margin: EdgeInsets.symmetric(horizontal: 9,vertical: 5),
          color: Colors.transparent,
          child: ListTile(
            contentPadding: EdgeInsets.symmetric(horizontal: 11,vertical: 0),
            title: Text(Constants.allFileList[i].name,style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500,color: Colors.white.withOpacity(0.9)),),
            onTap: (){
